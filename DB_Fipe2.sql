...
#1. Utilizando o banco de dados fipe crie as tabelas clientes, vendas e itensvendidos, definindo corretamente as relações e chaves desta tabelas.
...
CREATE TABLE itensVendidos(
	...
	PRIMARY KEY(codvenda,codCarro),
	FOREIGN KEY(codvenda) REFERENCES Venda(codvenda),
	FOREIGN KEY(codCarro) REFERENCES Carros(codCarro)
);

#2. Cadastre 10 registros diferentes na tabela clientes.
INSERT INTO Cliente VALUES
('1','Joaquim Jose da Silva Xavier','MG'),
('2','Alberto Santos Dumont','MG'),
('3','Jose Abelardo Barbosa de Medeiros','PE'),
('4','Raul Santos Seixas','BA'),
('5','Tancredo de Almeida Neves','MG'),
('6','Janio da Silva Quadros','MS'),
('7','Renato Manfredini Junior','RJ'),
('8','Ana Beatriz Lima','RJ'),
('9','Matheus Santos Souza','BA'),
('10','Carlos Henrique de Andrade','SP');
